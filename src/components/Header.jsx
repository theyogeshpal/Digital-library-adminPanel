  ...
  return (
    <header className="bg-white/70 backdrop-blur-xl shadow-lg border-b border-white/20 p-4 sm:p-6 flex justify-between items-center sticky top-0 z-10">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">Dashboard</h1>
          <p className="text-xs sm:text-sm text-slate-500 mt-1 hidden sm:block">Welcome back, Admin</p>
        </div>
      </div>
      <div className="flex items-center gap-2 sm:gap-4">
        <div className="relative hidden md:block">
          ...
          <input 
            type="text" 
            placeholder="Search..." 
            className="pl-10 pr-4 py-2 bg-slate-100 rounded-xl border-0 focus:ring-2 focus:ring-blue-500 outline-none w-40 lg:w-64"
          />
        </div>
